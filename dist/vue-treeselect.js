...
/* harmony default export */ var treeselectMixin = ({
  ...
  methods: {
    ...
    selectAll: function selectAll() {
      ...
      var nodes = this.visibleOptionIds.map(this.getNode).filter(function (node) {
        return (_this20.localSearch.active && node.isMatched || !_this20.localSearch.active) && !node.isDisabled && !_this20.isSelected(node);
      });
      nodes.forEach(function (node) {
        var nextState = _this20.multiple && !_this20.flat ? _this20.forest.checkedStateMap[node.id] === UNCHECKED : !_this20.isSelected(node);

        if (nextState) {
          _this20._selectNode(node);
        }

        _this20.buildForestState();

        if (nextState) {
          _this20.$emit('select', node.raw, _this20.getInstanceId());
        } else {
          _this20.$emit('deselect', node.raw, _this20.getInstanceId());
        }

        if (_this20.localSearch.active && nextState && (_this20.single || _this20.clearOnSelect)) {
          _this20.resetSearchQuery();
        }

        if (_this20.single && _this20.closeOnSelect) {
          _this20.closeMenu();

          if (_this20.searchable) {
            _this20._blurOnSelect = true;
          }
        }
      });
    },
...
/* harmony default export */ var SelectAllvue_type_script_lang_js_ = ({
  name: 'vue-treeselect--v'
});
// CONCATENATED MODULE: ./src/components/icons/SelectAll.vue?vue&type=script&lang=js&
 /* harmony default export */ var icons_SelectAllvue_type_script_lang_js_ = (SelectAllvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/icons/SelectAll.vue
...
SelectAll_component.options.__file = "SelectAll.vue"
/* harmony default export */ var SelectAll = (SelectAll_component.exports);
...
/* harmony default export */ var Controlvue_type_script_lang_js_ = ({
  ...
  methods: {
    renderV: function renderV() {
      var h = this.$createElement;
      var instance = this.instance;
      var title = instance.selectAllText;
      if (!instance.multiple) return null;
      return h("div", {
        "class": "vue-treeselect__v-container",
        attrs: {
          title: title
        },
        on: {
          "mousedown": this.handleMouseDownOnV
        }
      }, [h(SelectAll, {
        "class": "vue-treeselect__v"
      })]);
    },
  ...
  render: function render() {
    ...
    return h("div", {
      ...
      ref: "value-container"
    }), this.renderV(), this.renderX(), this.renderArrow()]);
  }
});
